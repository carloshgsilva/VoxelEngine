...
static const int DescriptorSetFontCount = 1;
static const int DescriptorSetMaxCount = 1024;
static int CurrentDescriptorSet = 0;
...
static VkDescriptorSet          g_DescriptorSets[DescriptorSetMaxCount];
...
void ImGui_ImplVulkan_RenderDrawData(ImDrawData* draw_data, VkCommandBuffer command_buffer, VkPipeline pipeline)
{
    ...
    CurrentDescriptorSet = DescriptorSetFontCount; // Reset CurrentDescriptor
...
bool ImGui_ImplVulkan_CreateFontsTexture(VkCommandBuffer command_buffer)
{
    ...
    VkDescriptorSet font_descriptor_set = (VkDescriptorSet)ImGui_ImplVulkan_Image(g_FontSampler, g_FontView, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL);
...
bool    ImGui_ImplVulkan_Init(ImGui_ImplVulkan_InitInfo* info, VkRenderPass render_pass)
{
    ...
    VkDescriptorSetLayout layouts[DescriptorSetMaxCount];
    for (int i = 0; i < DescriptorSetMaxCount; i++) {
    ...
    alloc_info.descriptorSetCount = DescriptorSetMaxCount;
    alloc_info.pSetLayouts = layouts;
    VkResult err = vkAllocateDescriptorSets(g_VulkanInitInfo.Device, &alloc_info, g_DescriptorSets);
    check_vk_result(err);
...
ImTextureID ImGui_ImplVulkan_Image(VkSampler sampler, VkImageView image_view, VkImageLayout image_layout) {
    VkResult err;

    ImGui_ImplVulkan_InitInfo* v = &g_VulkanInitInfo;
    VkDescriptorSet descriptor_set = g_DescriptorSets[CurrentDescriptorSet];
