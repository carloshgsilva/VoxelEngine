...
public:
	LightAmbientPipeline() {
		_Pipeline = GraphicsPipeline::Create(GraphicsPipeline::Info()
			...
			.vertexShader(FileUtil::ReadBytes("Mods/default/Shaders/LightAmbient.vert.spv"))
			.fragmentShader(FileUtil::ReadBytes("Mods/default/Shaders/LightAmbient.frag.spv"))
		);
	}
