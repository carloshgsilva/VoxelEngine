...
public:
	...
	OutlineVoxelPipeline() {
		_Pipeline = GraphicsPipeline::Create(GraphicsPipeline::Info()
			...
			.vertexShader(FileUtil::ReadBytes("Mods/default/Shaders/OutlineVoxel.vert.spv"))
			.fragmentShader(FileUtil::ReadBytes("Mods/default/Shaders/OutlineVoxel.frag.spv"))
		);
	}
